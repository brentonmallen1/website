...
BLOG_AUTHOR = "Brenton Mallen"  # (translatable)
BLOG_TITLE = "Brenton Mallen"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://brentonmallen.com/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://brentonmallen.com/"
BLOG_EMAIL = "brentonmallen1@gmail.com"
BLOG_DESCRIPTION = "This is the blog site of Brenton Mallen."  # (translatable)
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        (
            (
                ("/pages/bio", "Bio"),
                ("/files/resume/mallen_cv_2018-10-12.pdf", 'Resume'),
...
#             ('https://twitter.com/BrentonMallen', 'My Twitter', 'fa fa-twitter'),
#             ('https://github.com/brentonmallen1', 'My Github', 'fa fa-github'),
#         )
#     }
